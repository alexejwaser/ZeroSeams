...
## Upcoming
AI: background removal UI, SAM segmentation, LaMa inpainting · Font picker + Google Fonts · Templates/presets · Publish/share · Windows packaging + auto-update · Video: volume normalization meter, playback rate, info panel full video metadata (codec, bitrate), poster frame thumbnail preview in layer panel (issue #42 remaining)
