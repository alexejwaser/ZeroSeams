...
## Corpus Check
- 19 files · ~74,407 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 887 nodes · 1454 edges · 66 communities (51 shown, 15 thin omitted)
...
Cohesion: 0.06
Nodes (43): currentFilePath in useSaveStatusStore, addRecentFile(), IPC: autosave-project, body, buf, corpHeaders, createWindow(), dir (+35 more)

### Community 4 - "Canvas Types & Grid Overlay"
Cohesion: 0.13
Nodes (38): Non-Destructive Photo Adjustments Pipeline, AIOperation, AIOperationBase, AIOperationStatus, BackgroundRemovalOperation, InpaintingOperation, SegmentationOperation, AnchorPoint (+30 more)
...
Cohesion: 0.14
Nodes (19): captureVideoFrameSequence(), downloadFrames(), exportMixedFrames(), ExportResult, canvas/index exports, posixDirname(), posixRelative(), posixResolve() (+11 more)
...
## Knowledge Gaps
- **289 isolated node(s):** `composite`, `noEmit`, `module`, `moduleResolution`, `target` (+284 more)
...
- **Why does `Electron Vite Config` connect `Electron-Vite Build Config` to `Dev Dependencies`, `Mask Draw Verify Script`, `Video Test Suite`, `Debug Selection Scripts`, `Axis Lock Tests`?**
  _High betweenness centrality (0.038) - this node is a cross-community bridge._
- **Why does `devDependencies` connect `Dev Dependencies` to `Electron-Vite Build Config`, `Package Dependencies`?**
...
- **Should `Multiselect Transform Tests` be split into smaller, more focused modules?**
