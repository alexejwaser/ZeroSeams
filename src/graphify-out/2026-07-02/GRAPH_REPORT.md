...
## Corpus Check
- 81 files · ~78,856 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1053 nodes · 2325 edges · 70 communities (53 shown, 17 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 67 edges (avg confidence: 0.82)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4590cf72`
...
Cohesion: 0.05
Nodes (90): removeBg, CanvasGroupNode(), CanvasGroupNodeInner, CanvasGroupNodeProps, hitTestCell(), CanvasGuidelineNode, CanvasGuidelineNodeInner(), CanvasGuidelineNodeOuter() (+82 more)
...
Cohesion: 0.22
Nodes (26): adjFingerprint(), build3DLUT(), buildFilterPipeline(), buildFloatLUT(), buildLUT(), evict(), floatLutCache, hslToRgb() (+18 more)
...
Cohesion: 0.12
Nodes (28): Photo Adjustments Bypass Toggle (hold-to-compare \ key + persistent Power button), rotateAroundCenter: Konva Rect/Text rotate around top-left not center; ellipse exempt, FontPicker(), MAC_SYSTEM_FONTS, AdjustmentsSection(), AdjustmentsSectionProps, alignButtonStyle(), AlignDistributeSection() (+20 more)

### Community 11 - "Export & Path Utilities"
Cohesion: 0.17
Nodes (17): captureVideoFrameSequence(), downloadFrames(), exportMixedFrames(), ExportResult, buildProjectSnapshot(), getVideoElement(), registerVideoElement(), registry (+9 more)
...
Cohesion: 0.22
Nodes (17): clamp(), ColorInput(), ColorInputProps, ColorMode, ColorPopover(), hexToHsl(), hexToRgb(), hslToHex() (+9 more)
...
Cohesion: 0.40
Nodes (3): formatVal(), NumericInput(), NumericInputProps
...
Cohesion: 0.14
Nodes (16): GridPicker(), ActiveTool, blobToBase64(), buildProjectJson(), PLATFORM_RECOMMENDED, PresetKey, SaveStatusPill(), TitleBar() (+8 more)
...
Cohesion: 0.17
Nodes (12): Electron-Vite Three-Target Build (main/preload/renderer), Electron Vite Config, TypeScript Node Config, TypeScript Root Config, TypeScript Web Config, devDependencies, playwright, @types/chokidar (+4 more)
...
Cohesion: 0.12
Nodes (17): Save Split-Button Pattern (Save / Save As / Save a Copy), Module-level activeTooltipCount (instant tooltip on hover when any tooltip is visible), App(), rootEl, FrameSettingsPopover(), FrameSettingsPopoverProps, labelStyle, numberInputStyle (+9 more)
...
## Knowledge Gaps
- **210 isolated node(s):** `AlignDistributeSectionProps`, `VideoExportSettingsPanelProps`, `UseColorPopoverOptions`, `ImageFormat`, `DEFAULT_IMAGE_EXPORT_SETTINGS` (+205 more)
...
- **Why does `useCanvasStore` connect `Canvas Node Rendering` to `Autosave & Save Status`, `Layer Panel & Tooltip`, `Properties Panel UI`, `Text Span Editing`, `AI Store & Context`, `Preview & Platform Shells`, `Grid Templates & Picker`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `dependencies` connect `Package Dependencies` to `FFmpeg Core Runtime`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **Why does `Electron Vite Config` connect `Dev Dependencies` to `Debug Selection Scripts`, `Axis Lock Tests`, `Mask Draw Verify Script`, `Video Test Suite`?**
...
- **Should `Canvas Node Rendering` be split into smaller, more focused modules?**
  _Cohesion score 0.0509673852957435 - nodes in this community are weakly interconnected._
